...
class DockerContainerFactory(instance: InvokerInstanceId,
  ...
  override def createContainer(tid: TransactionId,
    ...
    println(s"DockerContainerFactory\n instance:$instance \n parameters:$parameters \n  containerArgsConfig:$containerArgsConfig ")
    println(s"runtimesRegistryConfig:$runtimesRegistryConfig\n  userImagesRegistryConfig: $userImagesRegistryConfig\n dockerContainerFactoryConfig: $dockerContainerFactoryConfig")
    println(s"create\n registryConfig resolve:$registryConfig\n image: $image  ")
