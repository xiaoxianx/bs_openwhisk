...
class StandaloneDockerContainerFactory(instance: InvokerInstanceId, parameters: Map[String, Set[String]])(
  ...
  override def createContainer(tid: TransactionId,
    ...
    println(s"StandaloneDockerContainerFactory  pullediamge pulledImages = new TrieMap \n $pulledImages \n factoryConfig,loadStandaloneDockerConfig : $factoryConfig ")
    println(s"actionImage: $actionImage\nruntimesRegistryConfig:${runtimesRegistryConfig.url}")
    println(s" image $imageName\n pulled $pulled  ")
