...
object Invoker {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val poolConfig: ContainerPoolConfig = loadConfigOrThrow[ContainerPoolConfig](ConfigKeys.containerPool)//whisk.container-pool
    val limitConfig: ConcurrencyLimitConfig = loadConfigOrThrow[ConcurrencyLimitConfig](ConfigKeys.concurrencyLimit)// "whisk.concurrency-limit"
 ...
 * The given invoker may require corresponding 相应的RestAPI implementation.
 */
