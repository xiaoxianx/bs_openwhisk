 ...
 *
 * It is possible to deploy a hot-standby 双机热备controller. Each controller needs its own instance. This instance is a
 * consecutive连续不断的 numbering, starting with 0.
